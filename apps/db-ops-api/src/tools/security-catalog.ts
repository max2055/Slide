...
const TOOL_SECURITY_CATALOG: Readonly<Record<string, ToolSecurityDefinition>> = Object.freeze({
  ...
  slide_record_feedback: definition('actor', 'write', 'none', [], 'never', 'none', 'none'),
  ...
  evaluate_evidence: definition('actor', 'read', 'none', [], 'never', 'none', 'none'),
  record_evidence_decision: definition('actor', 'write', 'none', [], 'never', 'none', 'none'),
  verify_operation_recovery: definition('actor', 'read', 'none', [], 'never', 'none', 'none'),
  get_deployment_manifest: definition('actor', 'read', 'none', ['config:view'], 'never', 'none', 'none'),
  search_source: definition('actor', 'read', 'none', ['config:view'], 'never', 'none', 'none'),
  read_source_region: definition('actor', 'read', 'none', ['config:view'], 'never', 'none', 'none'),
  get_symbol_definition: definition('actor', 'read', 'none', ['config:view'], 'never', 'none', 'none'),
  get_platform_observations: definition('actor', 'read', 'none', ['config:view'], 'never', 'none', 'none'),
