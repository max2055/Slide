...
ALTER TABLE metrics_history
  ...
  MODIFY COLUMN active_transactions INT DEFAULT NULL,
  MODIFY COLUMN slow_queries INT DEFAULT NULL,
  MODIFY COLUMN buffer_pool_hit_rate DECIMAL(5,2) DEFAULT NULL COMMENT '缓冲池命中率 %',
  MODIFY COLUMN threads_running INT DEFAULT NULL,
  MODIFY COLUMN threads_connected INT DEFAULT NULL,
  MODIFY COLUMN bytes_received BIGINT DEFAULT NULL,
  MODIFY COLUMN bytes_sent BIGINT DEFAULT NULL,
  MODIFY COLUMN queries_total BIGINT DEFAULT NULL,
  MODIFY COLUMN commits_total BIGINT DEFAULT NULL,
  MODIFY COLUMN rollbacks_total BIGINT DEFAULT NULL,
