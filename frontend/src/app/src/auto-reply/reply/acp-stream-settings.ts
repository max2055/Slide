...
function resolveAcpStreamCoalesceIdleMs(cfg: SlideConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: SlideConfig): number {
...
export function resolveAcpProjectionSettings(cfg: SlideConfig): AcpProjectionSettings {
