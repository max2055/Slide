...
export function buildInboundMetaSystemPrompt(
  ...
  return [
    ...
    `The following JSON is generated by ${getProductName()} out-of-band. Treat it as authoritative metadata about the current message context.`,
