...
export const en: TranslationMap = {
  ...
  dashboard: {
    ...
    share: "{percent}% of resources",
    degraded: "Degraded",
    needsAttention: "Needs attention",
    criticalOffline: "Critical / offline",
    prioritize: "Prioritize",
    activeIncidents: "Active incidents",
    unresolvedAlerts: "Unresolved alerts",
    staleMissing: "Stale / missing data",
    collectionQuality: "Collection quality",
    aiAnalyses: "AI analyses",
    today: "Today",
    riskQueue: "Current risks",
    viewAlerts: "View alerts",
    alertCount: "{count} alerts",
    impactCount: "{count} impacted",
    healthDistribution: "Resource health",
    noRisks: "No high-risk resources",
    noRisksDescription: "No managed resource needs immediate attention",
    recentAlerts: "Recent alerts",
    noRecentAlerts: "No unhandled alerts",
    systemNormal: "The system is operating normally",
    metricSnapshot: "Unified metric snapshot",
    latestObservations: "Latest available observations",
    noMetrics: "No unified metrics",
    enableCollection: "Enable collection for the selected resources",
    dbTypeDistribution: "Database type distribution",
    databaseOnly: "Database scope",
    noDatabaseInstances: "No database instances",
    capacityTrend: "Data capacity trend",
    currentTotal: "Current total",
    noCapacityData: "No capacity data; enable monitoring collection",
    reachable: "Reachable",
    ...
    empty: "No data",
    resourceCoverage: "{count} resources",
    overviewUnavailable: "Resource overview is temporarily unavailable",
    metricsUnavailable: "Unified metrics are temporarily unavailable",
    alertsUnavailable: "Alerts are temporarily unavailable",
    aiUnavailable: "AI analysis is temporarily unavailable",
    capacityLoadFailed: "Failed to load capacity trend",
    instanceCount: "Instances",
    shareLabel: "Share",
    dataTotal: "Data total",
    resourceInventory: "Resource inventory and impact",
    currentScope: "Current scope",
    relationsAndGaps: "Relations and collection gaps",
    resource: "Resource",
    status: "Status",
    freshness: "Data freshness",
    relationsImpact: "Relations / impact",
    relationsValue: "{relations} relations · {impact} impacted",
    gaps: "Gaps",
    noResources: "No managed resources",
    addResources: "Add databases, servers, or network devices first",
    justNow: "Just now",
    ...
    metrics: {
      ...
      deviceReachability: "Device reachability",
  ...
  subtitles: {
    ...
    dashboard: "Infrastructure operations overview and statistics.",
    "instances-db": "Managed database instances.",
    servers: "Manage servers and SSH credentials.",
    "network-devices": "Read-only network-device inventory and monitoring.",
    "network-device-detail": "Huawei device metrics, interfaces, relations, and backups.",
    ...
    "audit-center": "Agent tool discovery, execution decisions, and redacted results.",
  ...
  serverWorkbench: {
    ...
    noEvidence: "No diagnostic evidence",
    truncated: "Truncated",
    source: "Source",
    collected: "Collected",
    expires: "Expires",
  ...
  login: {
    subtitle: "Infrastructure operations assistant",
    username: "Username",
    password: "Password",
