...
import { extractCanvasFromText } from "../../src/chat/canvas-render.ts";
  ...
  return html`
    <div class="chat-tool-card__raw">
      ...
      >
        ...
        <span class="chat-tool-card__raw-toggle-icon">${icons['chevron-down']}</span>
      </button>
        ...
        ${canOpenSidebar
          ? html`
              <div class="chat-tool-card__actions">
                ...
                >
                  <span class="chat-tool-card__action-icon">${icons['panel-right-open']}</span>
                </button>
              </div>
            `
          : nothing}
