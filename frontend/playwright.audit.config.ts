...
export default defineConfig({
  testDir: './e2e',
  testMatch: ['audit-dialog.spec.ts', 'dashboard-overview.spec.ts', 'network-device-scheduling.spec.ts', 'readability.spec.ts', 'llm-scenes.spec.ts', 'source-sync.spec.ts'],
