...
- ✅ **v0.3 RBAC + SQL Console + Dashboard** — Phases 84-89 (shipped 2026-05-13)
- ✅ **v0.4 UI + AI + Docs** — Phases 90-99 (shipped 2026-05-20)
...
<details>
<summary>✅ v0.3 RBAC + SQL Console + Dashboard (Phases 84-89) — SHIPPED 2026-05-13</summary>
...
<details>
<summary>✅ v0.4 UI + AI + Docs (Phases 90-99) — SHIPPED 2026-05-20</summary>
...
**Depends on**: Nothing (foundation for v0.4)
...
**Depends on**: Phase 90, Phase 91, Phase 92, Phase 93 (should reflect final v0.4 feature set)
**Requirements**: DOC-01
**Success Criteria** (what must be TRUE):
...
- [x] 94-02-PLAN.md -- OPERATIONS.md (full-stack ops: backend, Gateway, frontend, deps) + USER-GUIDE.md (v0.4 all modules, with FAQ and screenshot placeholders)
...
|-------|-----------|----------------|--------|-----------|
| 84. RBAC Foundation | v0.3 | 4/4 | Complete | 2026-05-09 |
| 85. RBAC Frontend | v0.3 | 2/2 | Complete | 2026-05-10 |
| 86. SQL Console Upgrade | v0.3 | 5/5 | Complete | 2026-05-10 |
| 87. Approval Enhancement | v0.3 | 4/4 | Complete | 2026-05-11 |
| 88. Dashboard Upgrade | v0.3 | 2/2 | Complete | 2026-05-11 |
| 89. Gap Closure | v0.3 | 5/5 | Complete | 2026-05-13 |
| 90. OpenClaw Upstream Merge | v0.4 | 0/2 | Deferred | - |
| 91. UI Standardization | v0.4 | 2/2 | Complete | 2026-05-14 |
| 92. AI Analysis Visibility | v0.4 | 5/5 | Complete | 2026-05-14 |
| 93. AI Agent Ops Assistant | v0.4 | 6/6 | Complete | 2026-05-15 |
| 94. Project Documentation | v0.4 | 3/3 | Complete | 2026-05-17 |
| 95. Dameng Database Support | v0.4 | 2/2 | Complete | 2026-05-18 |
| 96. Oracle Database Support | v0.4 | 4/4 | Complete | 2026-05-19 |
| 97. SQL History Persistence | v0.4 | 1/1 | Complete | 2026-05-20 |
| 98. Chat Agent Selector UI | v0.4 | 1/1 | Complete | 2026-05-16 |
| 99. db-connection-auto-recovery | v0.4 | 2/2 | Complete | 2026-05-19 |
| 100. 安全紧急修复 | v0.5 | 2/2 | Complete    | 2026-05-20 |
| 101. 认证权限 | v0.5 | 4/4 | Complete    | 2026-05-20 |
| 102. UI 统一 | v0.5 | 3/3 | Complete    | 2026-05-21 |
| 103. 报表重构 | v0.5 | 3/3 | Complete   | 2026-05-21 |
| 104. 告警系统增强 | v0.5 | 3/3 | Complete    | 2026-05-21 |
| 105. 数据质量 | v0.5 | 2/2 | Complete    | 2026-05-21 |
| 106. 指标采集可配置化 | v0.5 | 4/4 | Complete | 2026-05-22 |
| 107. 实例详情页指标动态化 | v0.5 | 2/2 | Complete    | 2026-05-27 |
| 108. Agent 抽象层 | v0.6 | 3/3 | Complete    | 2026-05-25 |
| 109. Agent 引擎补全 | v0.6 | 4/4 | Complete    | 2026-05-26 |
| 110. 切换 & 验证 | v0.6 | 5/5 | Complete    | 2026-05-26 |
| 111. Gateway 简化 | v0.6 | 4/4 | Complete    | 2026-05-26 |
| 112. 前端清理 & 定时任务 | v0.6 | 3/3 | Complete    | 2026-05-27 |
| 113. AI Agent Cron | v0.6 | 4/4 | Complete    | 2026-05-27 |
| 114. Verification 清账 | v0.6 | 4/4 | Complete    | 2026-05-27 |
| 115. 去 OpenClaw 迁移后清理 | v0.6 | 5/5 | Complete    | 2026-06-02 |
| 116. 去 OpenClaw 运行时引用 | v0.6 | 4/4 | Complete    | 2026-06-02 |
...
**Goal:** 清理 v0.6 OpenClaw 迁移后的遗留事项 — 删除已替换的 Agent LLM 配置工具、修复 TODO 占位、清理前端残留引用和 OpenClaw 命名、添加 GitHub Actions CI pipeline
...
- v0.7 里程碑标记为 shipped (2026-06-20)
...
- rbac-page 手写 .modal-overlay/.modal → <app-dialog>（2 处 modal）

**表单输入统一** (1 commit):

- cron-jobs-settings/llm-config/metric-templates/users-management/rbac-page: 硬编码 px → design tokens
- font-size、padding、border-radius、gap 统一为 var(--text-*) / var(--space-*) / var(--radius-sm)
- focus ring 统一为 0 0 0 3px var(--accent-subtle)

**UI hint**: yes

| 117. OpenClaw收尾 | v0.6 | 3/3 | Complete    | 2026-06-02 |
| 118. Agent DB 连接 + 告警完善 | v0.6 | 2/2 | Complete    | 2026-06-08 |
| 119. 代码清理 (P0 Bug + 死代码) | v0.7 | 1/1 | Complete | 2026-06-10 |
| 120. 全面优化系统 UI | v0.7 | 8/8 | Complete | 2026-06-24 |
| 121. 产品打磨 | v0.7 | 5/5 | Complete | 2026-06-26 |
| 122. Cron Script Agent Mode | v0.7 | 3/3 | Complete ✅ UAT | 2026-06-29 |
| 123. AI 功能打磨 | v0.7 | 5/5 | Complete ✅ | 2026-07-01 |

### Phase 123: AI 功能打磨

**Goal:** 打磨 Agent 核心功能模块——Agent 交互体验、会话管理、Skill 管理、Tool 管理、LLM Provider 配置、AI 提示词管理——使其达到产品级可用状态。

**Background:** v0.6 完成了 Agent 引擎解耦和替换（108-118），但替换后的新功能模块缺少管理界面和用户体验打磨。用户目前无法查看/管理 Agent 会话、无法浏览可用 Skills/Tools、无法配置 LLM Provider 切换。本 Phase 聚焦于补齐这些管理能力，让 Agent 相关功能不再是"黑盒"。后续追加 Plan 05 优化 AI 提示词和工具描述。
...
**Success Criteria** (what must be TRUE):
  ...
  1. 用户可在前端查看 Agent 会话列表、消息历史和会话状态，支持手动结束会话
  2. Agent Skills 管理页面：列出已加载的 Skill 文件及其内容，支持启用/禁用
  3. Agent Tools 管理页面：列出所有注册工具及其 Schema 定义，显示调用统计
  4. LLM Provider 管理页面：查看/切换当前 Provider（Anthropic/OpenAI/Ollama），配置 API Key 和模型参数
  5. Agent 交互体验优化：错误提示可读性、Thinking 过程可视化、超时/重连提示
  6. Session 清理机制：自动清理过期会话，支持保留期配置
  7. AI 提示词管理：支持多版本切换、内联编辑、AI 优化、文件写回、热重载
  8. SKILL.md 工具引用修正为实际存在的工具
  9. invoke() 流式 hook：Agent 思考过程和工具调用在 chat 中可见

**Plans:** 5/5 plans complete

**Plan 05: AI 提示词优化工具** (2026-07-01)

- 创建 prompt-manager.ts 多版本加载/切换/热重载
- 创建 prompts/versions/ 目录，fault-diagnosis/alert-rca/topsql-analysis 各 v1+v2
- 修正 4 个 SKILL.md 中的工具引用错误
- 重写 check_health SKILL.md 和 tools.ts 描述
- 扩展 buildDefaultPrompt() 从 prompt-manager 加载
- 添加 6 个 prompt 管理 API 端点
- 创建前端提示词管理页面（设置子页）
- invoke() 替换 NoopHook 为流式 hook，捕获 thinking + tool calls
- 定时任务页面 15s 刷新闪屏修复
...
- [x] **Phase 127: 定时自动化巡检** - 服务器健康巡检报告（PDF/HTML/MD） (completed 2026-07-07)
...
- [x] 124-02-PLAN.md — Frontend: servers-page.ts (app-data-table + app-dialog + test-connection + key-rotation), navigation restructure (D-10/D-11/D-12), i18n update, app-render.ts wiring (Wave 2)
