...
本文档涵盖 Slide 基础运维助手的完整运维流程，包括数据库、Kylin/RHEL/CentOS 服务器和华为 VRP 网络设备的部署、采集策略、凭据安全、健康检查和故障排查。本文档适用于将 Slide 部署到开发或生产环境的运维人员。

---

## 系统概览

Slide v0.10 由多个服务组件构成，各组件通过不同的网络端口提供服务和通信。
